...
def fetch_github_activity(username: str) -> None:
    ...
    try:
        ...
        if e.code == 404:
            print(f"ERRO: Usuário '{username}' não foi encontrado no GitHub.")
        else:
            print(f"ERRO: A API do GitHub retornou o código HTTP {e.code}.")
    except urllib.error.URLError:
        print("ERRO: Não foi possível conectar à internet. Verifique sua conexão.")
